  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        intervention: "border-transparent bg-blue-600 text-white",
        control: "border-transparent bg-green-600 text-white",
        active: "border-transparent bg-green-100 text-green-800",
        completed: "border-transparent bg-blue-100 text-blue-800",
        dropped: "border-transparent bg-red-100 text-red-800",
        pending: "border-transparent bg-gray-100 text-gray-800",
        overdue: "border-transparent bg-orange-100 text-orange-800",
      },
    },
    defaultVariants: {
      variant: "default",
